...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('PAYMENT_SUCCESS', 'LOW_STOCK', 'ORDER_STATUS_CHANGE', 'SYSTEM');

-- AlterTable
ALTER TABLE "Drug" ADD COLUMN     "revenue" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "Analytics" (
    ...
    "totalDrugsSold" INTEGER NOT NULL DEFAULT 0,
